...
one sig tice2bduration extends Date {} { date = 1634594400 }
...
one sig proc2 extends Process {} {
    contains = se2 + eb2 + rt2a + ee2a + tice2b + xor
}


check {Safe} for 0 but 4455 State expect 0
check {NTime[163459441]} for 0 but 4455 State expect 0
...
//run {EmptyNetTermination} for 0 but 11 State expect 1

// Both end events are reachable
//run { some s: State | s.nodemarks[ee2a] = 1 } for 0 but 10 State expect 1
