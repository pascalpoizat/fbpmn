...
// fails: inconsistent. TO BE DEBUGGED
run { some s: State | s.nodemarks[ee1b] = 1 } for 0 but 15 State expect 1
/* and both simultaneously */
// fails: inconsistent. TO BE DEBUGGED
run { some s : State | s.nodemarks[ee1a] = 1 && s.nodemarks[ee1b] = 1 } for 0 but 6 Int, 20 State expect 1
