...
cVar ==
   "flow_to_f2" :> "_"@@ "flow_to_f3" :> "_"
cKind ==
   "flow_to_f2" :> Some@@ "flow_to_f3" :> Some
cCond ==
   "flow_to_f2" :> "f_flow_to_f2"@@ "flow_to_f3" :> "f_flow_to_f3"
...
aKind ==
   "Activity_071wli2" :> ACT_MOVE@@ "Activity_18vh6pp" :> ACT_MOVE
aUpdateVar ==
  [ i \in {} |-> {}]
aUpdateGMinus ==
  [ i \in {} |-> {}]
aUpdateGPlus ==
  [ i \in {} |-> {}]
aCond ==
   "Activity_071wli2" :> "f_Activity_071wli2"@@ "Activity_18vh6pp" :> "f_Activity_18vh6pp"
...
evalF(v,s,p,f) ==
IF f = "f_Activity_071wli2" THEN def_f_Activity_071wli2(v,s,p)ELSE IF f = "f_Activity_18vh6pp" THEN def_f_Activity_18vh6pp(v,s,p)ELSE IF f = "f_flow_to_f2" THEN def_f_flow_to_f2(v,s,p)ELSE IF f = "f_flow_to_f3" THEN def_f_flow_to_f3(v,s,p)
ELSE {  }
startloc ==
   "PId" :> "f1"
startsub ==
