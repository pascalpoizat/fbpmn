...
Var == { "here", "_", "znc", "znw", "locControllerId", "locPlanterId", "locSprayerId" }

varloc ==
   "ControllerId" :> "locControllerId"
@@ "PlanterId" :> "locPlanterId"
@@ "SprayerId" :> "locSprayerId"

locvar ==
   "locControllerId" :> "ControllerId"
@@ "locPlanterId" :> "PlanterId"
@@ "locSprayerId" :> "SprayerId"
...
cCond ==
   "Flow_0jot9v9" :> "f_Flow_0jot9v9"
@@ "Flow_0q7wp3m" :> "f_Flow_0q7wp3m"
@@ "Flow_10neqt1" :> "f_Flow_10neqt1"
@@ "Flow_143f8dn" :> "f_Flow_143f8dn"
@@ "Flow_15sulbd" :> "f_Flow_15sulbd"
@@ "Flow_1skh2ra" :> "f_Flow_1skh2ra"

def_f_Flow_0jot9v9(v,s,p) == ({ "base" } \intersect reachFrom(v[varloc[p]]))
...
@@ "Activity_01kew4w" :> ACT_UPDATE
@@ "Activity_03ue3iv" :> ACT_MOVE
@@ "Activity_04y084u" :> ACT_PASS
@@ "Activity_08iyx19" :> ACT_PASS
@@ "Activity_0c215j4" :> ACT_PASS
@@ "Activity_0c5l85e" :> ACT_PASS
@@ "Activity_0ioiiue" :> ACT_PASS
@@ "Activity_0plaha5" :> ACT_MOVE
@@ "Activity_0x9tdqh" :> ACT_PASS
@@ "Activity_196ygfc" :> ACT_UPDATE
@@ "Activity_1xs44yy" :> ACT_MOVE

aUpdateVar ==
   "Activity_01kew4w" :> "here"
@@ "Activity_196ygfc" :> "here"

aUpdateGMinus ==
   "Activity_01kew4w" :> { "toPlant" }
@@ "Activity_196ygfc" :> { "toWater" }
...
CodeCondition == { "f_Activity_00galsb", "f_Activity_03ue3iv", "f_Activity_0plaha5", "f_Activity_1xs44yy", "f_Flow_0jot9v9", "f_Flow_0q7wp3m", "f_Flow_10neqt1", "f_Flow_143f8dn", "f_Flow_15sulbd", "f_Flow_1skh2ra" }

evalF(v,s,p,f) ==
IF f = "f_Activity_00galsb" THEN def_f_Activity_00galsb(v,s,p)
ELSE IF f = "f_Activity_03ue3iv" THEN def_f_Activity_03ue3iv(v,s,p)
ELSE IF f = "f_Activity_0plaha5" THEN def_f_Activity_0plaha5(v,s,p)
ELSE IF f = "f_Activity_1xs44yy" THEN def_f_Activity_1xs44yy(v,s,p)
ELSE IF f = "f_Flow_0jot9v9" THEN def_f_Flow_0jot9v9(v,s,p)
ELSE IF f = "f_Flow_0q7wp3m" THEN def_f_Flow_0q7wp3m(v,s,p)
ELSE IF f = "f_Flow_10neqt1" THEN def_f_Flow_10neqt1(v,s,p)
ELSE IF f = "f_Flow_143f8dn" THEN def_f_Flow_143f8dn(v,s,p)
ELSE IF f = "f_Flow_15sulbd" THEN def_f_Flow_15sulbd(v,s,p)
