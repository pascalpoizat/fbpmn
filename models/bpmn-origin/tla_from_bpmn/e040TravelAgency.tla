...
ContainRel ==
  ...
  @@ "TravelAgency_" :> { "BoundaryEvent_19y0yk9", "EndEvent_17rlcaz", "EndEvent_10gqkzy", "SubProcess_1agd6n3", "Task_1bn6n5q", "ExclusiveGateway_1dc5v3z", "StartEvent_1f3jj6d", "BoundaryEvent_0j1yvnw", "IntermediateThrowEvent_0b4rm53" }
...
@@ "SequenceFlow_0p2zcuo" :> "Task_1bn6n5q"
...
@@ "SequenceFlow_1ey63mn" :> "BoundaryEvent_0j1yvnw"
...
@@ "SequenceFlow_1ey63mn" :> "IntermediateThrowEvent_0b4rm53"
...
@@ "SequenceFlow_0p2zcuo" :> NormalSeqFlow
...
@@ "SequenceFlow_1ey63mn" :> NormalSeqFlow
...
@@ "BoundaryEvent_0j1yvnw" :> [ attachedTo |-> "Task_1bn6n5q", cancelActivity |-> TRUE ]
