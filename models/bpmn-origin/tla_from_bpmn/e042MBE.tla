...
ContainRel ==
  "Pid" :> { "SubProcess_0gsfmc3", "InterruptBE", "EndEvent_0rzkmq3", "BoundaryEvent_0ofx7yq", "NonInterruptBE", "BoundaryEvent_0lkn8pc", "EndEvent_086sfn7", "EndEvent_08qbw2d", "StartEvent_1" }
...
@@ "SInterrupt" :> SendTask
@@ "StartEvent_1s47y70" :> TimerStartEvent
