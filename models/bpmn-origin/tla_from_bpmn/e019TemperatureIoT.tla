...
ContainRel ==
  "Process_0bvyh41" :> { "ReceiveTask_1cc6gb0", "ExclusiveGateway_186ksgk", "StartEvent_0tw9hoi", "Task_0amx3qc", "ExclusiveGateway_0h8c90b", "ExclusiveGateway_0qv0dm1", "IntermediateThrowEvent_1ab6lzx", "IntermediateThrowEvent_0zn5r2p", "ExclusiveGateway_04luead", "EndEvent_0wj7yv1", "Task_0yh5jmb", "ExclusiveGateway_1mr7igy", "Task_1pc6d9t", "ExclusiveGateway_0k9b245", "Task_18tknzx", "Task_1e6rsiy", "ExclusiveGateway_03bs3t5", "ExclusiveGateway_1t6g7zz", "ExclusiveGateway_0a8yao0", "ExclusiveGateway_095m84g", "Task_03ohewl", "IntermediateThrowEvent_1cd7dmz" }
  @@ "Process_0de8xa0" :> { "ExclusiveGateway_0uhrdet", "StartEvent_19zezl9", "ExclusiveGateway_0a5libn", "Task_01tkb3r", "IntermediateThrowEvent_0moj9p9", "ExclusiveGateway_1u3y4si", "EndEvent_14513uv", "IntermediateThrowEvent_1dkrxqj", "Task_0ca58zk" }
  @@ "Process_0vx28va" :> { "ExclusiveGateway_1feo3um", "ExclusiveGateway_0wtbkow", "ExclusiveGateway_0cpdpri", "IntermediateCatchEvent_1mqziug", "StartEvent_0tynlqh", "ExclusiveGateway_0sum07m", "Task_169t347", "ExclusiveGateway_19mjt5y", "EndEvent_0pa5oys", "Task_1e85hli", "Task_1spxdy2", "ExclusiveGateway_1izjr9z", "IntermediateThrowEvent_12cgsc9" }
  @@ "Process_17upgh4" :> { "ExclusiveGateway_1alxwt7", "IntermediateThrowEvent_1ajpgtk", "EndEvent_0joc303", "ExclusiveGateway_0d9bxab", "StartEvent_12o3x3s", "Task_0aihuup", "Task_1p5k4vg" }
  @@ "Process_1pqwd18" :> { "StartEvent_0mw9dyi", "Task_09igb82", "EndEvent_19aoxjz", "Task_1x71tep" }

Node == {
  "Process_1pqwd18","Process_0de8xa0","Process_0bvyh41","Process_17upgh4","Process_0vx28va","StartEvent_0mw9dyi","Task_09igb82","EndEvent_19aoxjz","Task_1x71tep","ExclusiveGateway_0uhrdet","StartEvent_19zezl9","ExclusiveGateway_0a5libn","Task_01tkb3r","IntermediateThrowEvent_0moj9p9","ExclusiveGateway_1u3y4si","EndEvent_14513uv","IntermediateThrowEvent_1dkrxqj","Task_0ca58zk","ReceiveTask_1cc6gb0","ExclusiveGateway_186ksgk","StartEvent_0tw9hoi","Task_0amx3qc","ExclusiveGateway_0h8c90b","ExclusiveGateway_0qv0dm1","IntermediateThrowEvent_1ab6lzx","IntermediateThrowEvent_0zn5r2p","ExclusiveGateway_04luead","EndEvent_0wj7yv1","Task_0yh5jmb","ExclusiveGateway_1mr7igy","Task_1pc6d9t","ExclusiveGateway_0k9b245","Task_18tknzx","Task_1e6rsiy","ExclusiveGateway_03bs3t5","ExclusiveGateway_1t6g7zz","ExclusiveGateway_0a8yao0","ExclusiveGateway_095m84g","Task_03ohewl","IntermediateThrowEvent_1cd7dmz","ExclusiveGateway_1alxwt7","IntermediateThrowEvent_1ajpgtk","EndEvent_0joc303","ExclusiveGateway_0d9bxab","StartEvent_12o3x3s","Task_0aihuup","Task_1p5k4vg","ExclusiveGateway_1feo3um","ExclusiveGateway_0wtbkow","ExclusiveGateway_0cpdpri","IntermediateCatchEvent_1mqziug","StartEvent_0tynlqh","ExclusiveGateway_0sum07m","Task_169t347","ExclusiveGateway_19mjt5y","EndEvent_0pa5oys","Task_1e85hli","Task_1spxdy2","ExclusiveGateway_1izjr9z","IntermediateThrowEvent_12cgsc9"
}

Edge == {
  "MessageFlow_18pje80","MessageFlow_1jgvn81","MessageFlow_0vinqwi","MessageFlow_0vwhu1f","MessageFlow_1bpo13k","MessageFlow_1hyly74","MessageFlow_0aje9sn","MessageFlow_1o3tyk4","MessageFlow_0nqzifu","MessageFlow_0dguqk7","MessageFlow_00ca6vp","SequenceFlow_1uup9ft","SequenceFlow_02i1zog","SequenceFlow_1ngsqgy","SequenceFlow_0j7d6k8","SequenceFlow_1rpwomj","SequenceFlow_0wqy81u","SequenceFlow_0vwirsp","SequenceFlow_1kk1jne","SequenceFlow_07vsnao","SequenceFlow_1fvktk8","SequenceFlow_0ilol45","SequenceFlow_0mr13bl","SequenceFlow_0477vxz","SequenceFlow_112gnsc","SequenceFlow_1vmz2u9","SequenceFlow_1pvcw5e","SequenceFlow_1715hka","SequenceFlow_1t7zsjn","SequenceFlow_0vmtagi","SequenceFlow_17eb2ri","SequenceFlow_04p0en0","SequenceFlow_0ha4jhs","SequenceFlow_0n8zfgy","SequenceFlow_1nnne6n","SequenceFlow_07ahv22","SequenceFlow_17faiz5","SequenceFlow_1o0bwvr","SequenceFlow_1w9mr57","SequenceFlow_1nacukm","SequenceFlow_0ipzp9y","SequenceFlow_0yclgws","SequenceFlow_1pvrfjg","SequenceFlow_15ortkr","SequenceFlow_1017nuh","SequenceFlow_1lr4cps","SequenceFlow_1n4vv49","SequenceFlow_0tbx7nt","SequenceFlow_14zismf","SequenceFlow_1quu0wg","SequenceFlow_0j98n24","SequenceFlow_0v1itpk","SequenceFlow_1dhqk99","SequenceFlow_127z28e","SequenceFlow_0jioz8d","SequenceFlow_07gw8yk","SequenceFlow_0rdqb09","SequenceFlow_0so9y7c","SequenceFlow_1tu3a1o","SequenceFlow_0yf7004","SequenceFlow_151xud0","SequenceFlow_00sw0ns","SequenceFlow_04ctmhl","SequenceFlow_1j073vl","SequenceFlow_18i2li3","SequenceFlow_0ik719b","SequenceFlow_1plf2me","SequenceFlow_0u67u7k","SequenceFlow_0jy3w8q","SequenceFlow_0eoboyu","SequenceFlow_1dtybq7","SequenceFlow_05ihnu4","SequenceFlow_15jyzqg"
}
...
CatN ==
   "Process_1pqwd18" :> Process
@@ "Process_0de8xa0" :> Process
@@ "Process_0bvyh41" :> Process
@@ "Process_17upgh4" :> Process
@@ "Process_0vx28va" :> Process
